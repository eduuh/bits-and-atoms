...
For details on the physical machines, check out [Homelab Hardware](/posts/homelab-hardware).
...
1. All manifests live in a [Git repository](https://github.com/eduuh/kube-homelab)
