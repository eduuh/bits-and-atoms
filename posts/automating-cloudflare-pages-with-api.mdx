...
Grabbed an API token from [the Cloudflare dashboard](https://dash.cloudflare.com/profile/api-tokens). You need `Account > Cloudflare Pages > Edit`, `Account > Account Settings > Read`, and (if you want to script DNS too) `Zone > DNS > Edit`.
